...
class ProductsFactory extends Factory
{
   ...
   */
   public function definition()
   {
      ...
      $valid_month = [0, 3, 12,24];
      return [
         'display_order' => 1,
         'pack_id' => $this->faker->uuid(),// uuid 20c59fd5-d327-4540-bee4-6a2f0ca4d3ee
         'pack_name' => 'Class Pack',//$this->faker->words(1, true), // 20 Class Pack
         'pack_description' => $this->faker->words(18, true),//20 Class Pack desc
         'pack_type' => $pack_type[array_rand($pack_type)], //$this->faker->words(5, true), // non_shareable non_shareable 
         'total_credit' => $this->faker->numberBetween(10, 50), // 10
         'tag_name' => $tag_name[array_rand($tag_name)],
         'validity_month' => $valid_month[array_rand($valid_month)], //0,3,12,24
         'pack_price' => $this->faker->numberBetween(500, 1000), // 23.54, //235.4
